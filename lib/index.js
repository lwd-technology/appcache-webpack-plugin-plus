  ...
  _createClass(AppCache, [{
    ...
    value: function prepareCache() {
      ...
      this.cache = this.cache.map(function (asset) {
        return asset.replace('{hash}', _this.hash);
      });
    }
  }, {
    key: 'source',
  ...
  _createClass(AppCachePlugin, [{
    ...
    value: function apply(compiler) {
      ...
      compiler.plugin('emit', function (compilation, callback) {
        var appCache = new AppCache(_this2.cache, _this2.network, _this2.fallback, _this2.settings, compilation.hash, _this2.comment);
